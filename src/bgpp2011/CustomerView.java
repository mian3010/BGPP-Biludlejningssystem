...
public class CustomerView extends View {
    ...
    public CustomerView(Canvas canvas)
    {
        ...
        topText = "Customers";
        customers.add(new Customer(1, "Toke Jensen", 11111111, "Vej 1, By 1"));
        customers.add(new Customer(2, "Magnus Stahl", 22222222, "Vej 2, By 2"));
        customers.add(new Customer(3, "Michael Søby Andersen", 33333333, "Vej 3, By 3"));
        customers.add(new Customer(4, "Jens Jensen", 44444444, "Vej 4, By 4"));
        customers.add(new Customer(5, "Lars Larsen", 55555555, "Vej 5, By 5"));
    }
    @Override
    public JPanel draw()
    {
