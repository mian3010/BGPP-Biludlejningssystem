...
public class Nexus {
	 private DataBaseCom db;
	    ...
	    /***
	     * @param Customer an object which must contain the changes wished made
	    ...
	    /***
	     * @param Reservation an object which must contain the changes wished made
	     * @return boolean true if change succeed, false if fail
	     * @throws SQLException further down the system for recovery 
	     */
	    ...
	    /***
	     * @param Vehicle an object which must contain the changes wished made
	     * @return boolean true if change succeed, false if fail
	     * @throws SQLException further down the system for recovery 
	     */
	    ...
	    /***
	     * @param VehicleType an object which must contain the changes wished made
	     * @return boolean true if change succeed, false if fail
	     * @throws SQLException further down the system for recovery 
	     */
