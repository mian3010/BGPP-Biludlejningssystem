...
public class Nexus {
	 private DataBaseCom db;
	     ...
	     * @param r A valid reservation with or without id, won't matter.
    	 ...
    	 * in the database.
    	 * @param c Any valid customer object.
    	 ...
    	 * in the database.
    	 * @param vt Any valid VehicleType object.
    	 ...
    	 * in the database.
    	 * @param v Any valid Vehicle object.
	     ...
	     * @param c A customer object with information corresponding to a post in the database
	     ...
	     * This method requests the database connected to this class that it deletes a post in a table
	     * with information corresponding EXACTLY to the object passed in the parameter.
	     * @param r A reservation object with information corresponding to a post in the database
	     * @return boolean true if the request was successful, false if the request failed.
	     */
	     ...
	     * This method requests the database connected to this class that it deletes a post in a table
	     * with information corresponding EXACTLY to the object passed in the parameter.
	     * @param v A vehicle object with information corresponding to a post in the database
	     * @return boolean true if the request was successful, false if the request failed.
	     */
	     ...
	     * This method requests the database connected to this class that it deletes a post in a table
	     * with information corresponding EXACTLY to the object passed in the parameter.
	     * @param vt A VehicleType object with information corresponding to a post in the database
	     * @return boolean true if the request was successful, false if the request failed.
	     */
	    ...
	    /***
	     * @param c an object which must contain the changes wished made
	     * @return boolean true if change succeed, false if fail
	     * @throws SQLException further down the system for recovery 
	     */
	    ...
	    /***
	     * @param r an object which must contain the changes wished made
	     * @return boolean true if change succeed, false if fail
	     * @throws SQLException further down the system for recovery 
	     */
	    ...
	    /***
	     * @param v an object which must contain the changes wished made
	     * @return boolean true if change succeed, false if fail
	     * @throws SQLException further down the system for recovery 
	     */
	    ...
	    /***
	     * @param vt an object which must contain the changes wished made
	     * @return boolean true if change succeed, false if fail
	     * @throws SQLException further down the system for recovery 
	     */
